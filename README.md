# kivopick.com — COD Multi-Geo Static Site
...
- **Contact email**: info@kivopick.com (auto-derived from domain)
...
This site is **100% static**. Deploy by uploading the entire `/kivopick.com/` folder to any static host:
