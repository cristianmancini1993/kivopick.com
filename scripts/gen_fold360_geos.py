...
COPY = {
    "cz": {
        ...
        "ty_alt": "Tým kivopick v práci: call centrum a logistika dobírky",
    },
}
...
def si_copy():
    return {
        ...
        "ty_alt": "Ekipa kivopick pri delu: klicni center in logistika COD",
    }
...
def hu_copy():
    return {
        ...
        "ty_alt": "A kivopick csapat munka közben: call center és COD logisztika",
    }
...
def sk_copy():
    ...
    c.update({
        ...
        "ty_alt": "Tím kivopick v práci: call centrum a logistika dobierky",
    })
    return c
...
def pl_copy():
    return {
        ...
        "ty_alt": "Zespół kivopick w pracy: call center i logistyka COD",
    }
...
def transform_lp(geo: str, g: dict, c: dict) -> str:
    ...
    t = t.replace("https://kivopick.com/it/fold360/", f"https://kivopick.com/{geo}/fold360/")
...
def transform_ty(geo: str, g: dict, c: dict) -> str:
    ...
    t = t.replace("Il team kivopick al lavoro: call center e logistica COD", c["ty_alt"])
...
def main():
    ...
    for geo in GEOS:
        url = f"https://kivopick.com/{geo}/fold360/"
        if url not in text:
            entry = f'  <url><loc>{url}</loc><lastmod>2026-07-25</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
            text = text.replace(
                "  <url><loc>https://kivopick.com/it/fold360/</loc>",
                entry + "  <url><loc>https://kivopick.com/it/fold360/</loc>",
                1,
            )
