...
<link rel="canonical" href="https://kivopick.com/{geo}/{slug}/landing.html">
</head>
<body>
...
<head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-18412106936"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){{dataLayer.push(arguments);}}
  gtag('js', new Date());

  gtag('config', 'AW-18412106936');
</script>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover">
<title>{title}</title>
<meta name="description" content="{description}">
<meta name="contact" content="info@kivopick.com">
...
<footer class="site-footer">
  <div class="container">
    <div class="site-footer__grid">
      <div>
        <a href="/" class="site-logo" aria-label="kivopick.com home">
          <span class="site-logo__text"><span class="site-logo__text-primary">kivopick</span><span class="site-logo__text-accent">.com</span></span>
        </a>
      ...
      <div>
        ...
        <ul class="site-footer__list">
          ...
          <li><a href="mailto:info@kivopick.com">info@kivopick.com</a></li>
        </ul>
      </div>
    </div>
    <div class="site-footer__bottom">
      © <span data-year>2026</span> <strong>Vicequattrostrade Srl</strong> — {rights}.
      <a href="/">kivopick.com</a>
    </div>
  </div>
</footer>
...
def render_thank_you(offer: str, cfg: dict, copy: dict, shared: dict, it_ty: str) -> str:
    ...
    html = html.replace(
        "Il team kivopick al lavoro: call center e logistica COD", shared["ty_alt"]
    )
...
def update_sitemap() -> None:
    ...
    for offer, cfg in GEOS.items():
        geo = cfg["geo"]
        slug = cfg["slug"]
        for loc in (f"https://kivopick.com/{geo}/{slug}/", f"https://kivopick.com/{geo}/{slug}/landing.html"):
            line = f'  <url><loc>{loc}</loc><lastmod>2026-08-11</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
            if loc not in text:
                entries.append(line)
    if not entries:
        return
    marker = '  <url><loc>https://kivopick.com/en/kemppi/landing.html</loc><lastmod>2026-08-11</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
    if marker in text:
